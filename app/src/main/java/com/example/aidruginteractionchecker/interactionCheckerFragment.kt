 ...
 * Use the [interactionCheckerFragment.newInstance] factory method to
...
class interactionCheckerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment interactionCheckerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            interactionCheckerFragment().apply {
